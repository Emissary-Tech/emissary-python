...
class Datasets(BaseSDK):
        ...
        *,
        ...
        request = models.CreateDatasetRequest(
            ...
            request_body=utils.get_pydantic_model(
                request_body, models.CreateDatasetRequestBody
            ),
        )
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, models.DatasetSummary)
    ...
    def get(
        ...
        *,
        ...
        request = models.RetrieveDatasetByIDRequest(
            project_id=project_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="retrieveDatasetById",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.DatasetDetail)
