...
res = s.projects.deployments.create(request_body={
...
res = s.projects.deployments.list(project_id="<id>")
...
res = s.projects.deployments.get(deployment_id="<id>", project_id="<id>")
...
s.projects.deployments.delete(deployment_id="<id>", project_id="<id>")
...
s.projects.deployments.cancel(deployment_id="<id>", project_id="<id>")
