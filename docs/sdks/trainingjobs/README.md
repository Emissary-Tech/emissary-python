...
res = s.projects.training_jobs.create(request_body={
...
res = s.projects.training_jobs.list(project_id="<id>")
...
res = s.projects.training_jobs.get(training_job_id="<id>", project_id="<id>")
...
s.projects.training_jobs.delete(training_job_id="<id>", project_id="<id>")
...
s.projects.training_jobs.cancel(training_job_id="<id>", project_id="<id>")
...
res = s.projects.training_jobs.list_checkpoints(training_job_id="<id>", project_id="<id>")
